About pandas-datapackage-reader-feedstock
=========================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pandas-datapackage-reader-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8738&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pandas-datapackage-reader-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pandas-datapackage-reader` can be installed with `conda`:
...
```
mamba install pandas-datapackage-reader
```

It is possible to list all of the versions of `pandas-datapackage-reader` available on your platform with `conda`:
...
```
mamba search pandas-datapackage-reader --channel conda-forge
```
...
mamba repoquery search pandas-datapackage-reader --channel conda-forge

# List packages depending on `pandas-datapackage-reader`:
mamba repoquery whoneeds pandas-datapackage-reader --channel conda-forge

# List dependencies of `pandas-datapackage-reader`:
mamba repoquery depends pandas-datapackage-reader --channel conda-forge
```
